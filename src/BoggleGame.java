...
public class BoggleGame extends JFrame {
    ...
    public BoggleGame(int rows, int cols) {
        ...
        In in1 = new In(new File("/run/media/bert/280AC22E0AF59495/coursera/algorithms/2/assignments/5Boggle/boggle/dictionary-shakespeare.txt"));
        shakespeareDictionary = new SET<String>();
        for (String s : in1.readAllStrings())
            shakespeareDictionary.add(s);

        // all words in shakespeare
        In in2 = new In(new File("/run/media/bert/280AC22E0AF59495/coursera/algorithms/2/assignments/5Boggle/boggle/dictionary-nursery.txt"));
        nurseryDictionary = new SET<String>();
        for (String s : in2.readAllStrings())
            nurseryDictionary.add(s);

        // about 20K common words
        In in3 = new In(new File("/run/media/bert/280AC22E0AF59495/coursera/algorithms/2/assignments/5Boggle/boggle/dictionary-common.txt"));
        commonDictionary = new SET<String>();
        for (String s : in3.readAllStrings())
            commonDictionary.add(s);

        // all words in Algorithms 4/e
        In in4 = new In(new File("/run/media/bert/280AC22E0AF59495/coursera/algorithms/2/assignments/5Boggle/boggle/dictionary-algs4.txt"));
        algs4Dictionary = new SET<String>();
        for (String s : in4.readAllStrings())
            algs4Dictionary.add(s);

        // dictionary
        In in = new In(new File("/run/media/bert/280AC22E0AF59495/coursera/algorithms/2/assignments/5Boggle/boggle/dictionary-yawl.txt"));
